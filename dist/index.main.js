...
function populateToDo(object) {
    ...
    projDue.id = 'due-info';
    projDue.innerHTML = "Due: " + (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.format)(object.dueDate, 'MMMM do yyyy');
 ...
 // project info has a button to mark the project complete or incomplete
    ...
    for (let i = 0; i < object.list.length; i++) {
        ...
        toDoDate.innerHTML = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.format)(object.list[i], 'MMM do yyyy');
